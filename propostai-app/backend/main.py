"""
PropostAI SaaS — Backend FastAPI
...
async def lifespan(app: FastAPI):
    ...
    setup_logging()
    init_sentry()
    logger.info("Starting PropostAI", version=settings.VERSION)
    if settings.DEBUG:
        await init_db()
...
from apis.v1.propostai.proposals import router as proposals_router
