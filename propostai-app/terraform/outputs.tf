output "service_url" {
  ...
  value       = google_cloud_run_v2_service.propostai.uri
}
...
output "artifact_registry_repo" {
  ...
  value       = "${var.region}-docker.pkg.dev/${var.project_id}/${google_artifact_registry_repository.propostai.repository_id}"
}
