...
│
├── propostai-app/                              Active code — multi-tenant scaffold
...
└── legacy/                                        Archived — see legacy/README.md
    └── propostai-monolith/                     Previous FastAPI + vanilla HTML monolith (no auth, no multi-tenancy)
```
...
| See what changes to align propostai with the platform | [`docs/PLAN_SIL_PROPOSTA_ALIGN_SAAS_v2.md`](docs/PLAN_SIL_PROPOSTA_ALIGN_SAAS_v2.md) |
| Run the current backend | [`propostai-app/README.md`](propostai-app/README.md) |
| See what was retired and why | [`legacy/README.md`](legacy/README.md) |

## Conventions

- New code goes in `propostai-app/`.
...
`https://github.com/aigarage2026/propostai`
