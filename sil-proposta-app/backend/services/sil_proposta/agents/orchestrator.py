...
class OrchestratorAgent:
    ...
    async def run(self) -> dict:
        ...
        from services.sap_proposal.agents.sd_agent import SDAgent
        from services.sap_proposal.agents.fi_agent import FIAgent
        from services.sap_proposal.agents.abap_agent import ABAPAgent
        ...
        from services.sap_proposal.agents.drc_agent import DRCAgent
        from services.sap_proposal.agents.fiscal_estadual_agent import FiscalEstadualAgent
        from services.sap_proposal.agents.fiscal_federal_agent import FiscalFederalAgent
        from services.sap_proposal.agents.equipe_agent import EquipeAgent
        from services.sap_proposal.agents.comercial_agent import ComercialAgent
