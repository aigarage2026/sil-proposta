"""
Sil-Proposta — Orquestrador Determinístico v5 (v3 Onda 5).
...
from services.sil_proposta.agents.catalog import (
    EXCLUSOES_PADRAO,
    PREMISSAS_PADRAO,
    build_entregaveis,
    calculate_team,
...
from services.sil_proposta.agents.llm_client import LLMClient, parse_llm_json
...
async def _detalhar_abap_item(ctx: _AgentContext, obj: dict) -> None:
    ...
    system = (
        "Você é um arquiteto ABAP sênior SAP da Cast Group.\n"
...
async def _detalhar_modulo_funcional(
    ...
    system = (
        f"Você é um arquiteto SAP {modulo} sênior da Cast Group.\n"
