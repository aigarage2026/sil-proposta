"""
Agent Hub client — integracao com a plataforma AI Garage.
...
class AgentHubClient:
    """Client para comunicacao com Agent Hub."""

    def __init__(self):
        self.base_url = settings.AGENT_HUB_API_URL
        self.api_key = settings.AGENT_HUB_API_KEY
    ...
    async def get_subscription(self, tenant_id: str) -> dict:
        """Consulta subscription do tenant no Agent Hub."""
...
def get_agent_hub_client() -> AgentHubClient:
